import {
  ...
  : "http://localhost:3000";
  export const ChakriVerificationEmail = ({email}:any) => (
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container} className="bg-stone-50 rounded-sm p-7">
          ...
          <Text style={footerText}>
            This message was emailed to [`${email}`] by CHAKRI because you created a CHAKRI account.
          </Text>
          <Text style={footerText}>
  ...
  export default ChakriVerificationEmail;
